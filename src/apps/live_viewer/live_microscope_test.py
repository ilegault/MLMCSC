...
class SimpleWorkingLiveViewer:
    ...
    def __init__(self,
                 ...
                 calibration_path: str = "src/camera/data/microscope_calibration.json"):
        """
    ...
    def _load_shiny_region_model(self) -> bool:
        ...
        try:
            ...
            if hasattr(model_data, 'predict_shear_percentage'):
                ...
                logger.info("Model data keys:", list(model_data.keys()))
...
def main():
    ...
    # Paths - your new model should be in the main directory
    yolo_model_path = "../../models/charpy_3class/charpy_3class_20250729_110009/weights/best.pt"
    regression_model_path = "charpy_shear_regressor.pkl"  # Your new model!
    calibration_path = "../camera/data/microscope_calibration.json"
    ...
    viewer = SimpleWorkingLiveViewer(
