...
def main():
    ...
    # Default model path - update this to your trained model
    # Get the project root directory (parent of scripts folder)
    project_root = Path(__file__).parent.parent
    model_path = project_root / "models/charpy_3class/charpy_3class_20250729_110009/weights/best.pt"

    # Check if default path exists, otherwise ask user
    if not model_path.exists():
        print("❌ Default model path not found")
        print("Please enter the path to your trained model")
        print("(e.g., models/charpy_3class/charpy_3class_20250729_110009/weights/best.pt)")

        user_path = input("Model path: ").strip()
